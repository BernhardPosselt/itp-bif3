...
DATABASES = {
    'default': {
        ...
        'NAME': 'infoscreen_website',                      # Or path to database file if using sqlite3.
        'USER': 'infoscreen_user',                      # Not used with sqlite3.
        'PASSWORD': 'infoscreen',                  # Not used with sqlite3.
...
STATICFILES_DIRS = (
    # os.path.join( INSTALL_DIR, 'screen/static/'),
...
SECRET_KEY = 'sf-n20bve#xup*%t=)%u=tfx17%09#^a5^3sn4(&i+zeb_u*-m'
